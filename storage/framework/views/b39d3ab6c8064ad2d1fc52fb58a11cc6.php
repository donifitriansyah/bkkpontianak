...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid">
        <h1 class="h3 mb-3">Struktur Organisasi</h1>
        ...
        <div class="card shadow">
            <div class="card-header d-flex justify-content-between">
                <h6 class="font-weight-bold">Data Struktur Organisasi</h6>
                            ...
                            <div class="modal fade" id="editModal<?php echo e($item->id); ?>">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <form method="POST"
                                            action="<?php echo e(route('admin-struktur-organisasi.update', $item->id)); ?>">
                                            <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="createModal">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form method="POST" action="<?php echo e(route('admin-struktur-organisasi.store')); ?>">
                    <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        function uploadImage(file, editor) {
            ...
            $.ajax({
                url: "<?php echo e(route('struktur-organisasi.upload-image')); ?>",
                type: "POST",
                data: data,
                contentType: false,
                processData: false,
...
<?php echo $__env->make('layouts.back', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\OneDrive - MSFT\02. Pekerjaan\11. Kemenkes BKK Kelas I Pontianak\bkkpontianak\resources\views/pages/backend/profil/struktur-organisasi/index.blade.php ENDPATH**/ ?>