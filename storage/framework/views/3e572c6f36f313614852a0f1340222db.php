...
<?php $__env->startSection('content'); ?>
    ...
    <script>
        ...
        document.getElementById("btn-ipb").addEventListener("click", function() {
            setActive('btn-ipb');
            fetch("<?php echo e(route('ppid.informasi-publik.ipb')); ?>")
        ...
        document.getElementById("btn-iptss").addEventListener("click", function() {
            setActive('btn-iptss');
            fetch("<?php echo e(route('ppid.informasi-publik.iptss')); ?>")
                .then(response => response.text())
                .then(html => {
                    document.getElementById("konten-dinamis").innerHTML = html;
                });
        ...
        document.getElementById("btn-ipsm").addEventListener("click", function() {
            setActive('btn-ipsm');
            fetch("<?php echo e(route('ppid.informasi-publik.ipsm')); ?>")
                .then(response => response.text())
                .then(html => {
                    document.getElementById("konten-dinamis").innerHTML = html;
                });
...
<?php echo $__env->make('layouts.detail', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\OneDrive - MSFT\02. Pekerjaan\11. Kemenkes BKK Kelas I Pontianak\bkkpontianak\resources\views/pages/frontend/ppid/informasi-publik.blade.php ENDPATH**/ ?>