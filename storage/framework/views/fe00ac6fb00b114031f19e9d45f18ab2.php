...
<?php $__env->startSection('content'); ?>
    ...
    <script>
        ...
        document.getElementById("btn-kip").addEventListener("click", function() {
            setActive('btn-kip');
            fetch("<?php echo e(route('ppid.regulasi.kip')); ?>")
        ...
        document.getElementById("btn-kemenkes").addEventListener("click", function() {
            ...
            fetch("<?php echo e(route('ppid.regulasi.kemenkes')); ?>")
                .then(response => response.text())
                .then(html => {
                    document.getElementById("konten-dinamis").innerHTML = html;
                });
...
<?php echo $__env->make('layouts.detail', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\OneDrive - MSFT\02. Pekerjaan\11. Kemenkes BKK Kelas I Pontianak\bkkpontianak\resources\views/pages/frontend/ppid/regulasi.blade.php ENDPATH**/ ?>