<?php $__env->startSection('title', 'Tugas Pokok & Fungsi'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid">
        <h1 class="h3 mb-3">Tugas Pokok & Fungsi</h1>
        ...
        <div class="card shadow">
            <div class="card-header d-flex justify-content-between">
                <h6 class="font-weight-bold">Data Tugas & Fungsi</h6>
                <?php if($data->count() < 1): ?>
                            ...
                            <div class="modal fade" id="editModal<?php echo e($item->id); ?>">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <form method="POST" action="<?php echo e(route('tugas-fungsi.update', $item->id)); ?>">
                                            <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="createModal">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form method="POST" action="<?php echo e(route('tugas-fungsi.store')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="modal-header">
    ...
    <script>
        ...
        function uploadImage(file, editor) {
            ...
            $.ajax({
                url: "<?php echo e(route('tugas-fungsi.upload-image')); ?>",
                type: "POST",
                data: data,
                contentType: false,
                processData: false,
...
<?php echo $__env->make('layouts.back', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\OneDrive - MSFT\02. Pekerjaan\11. Kemenkes BKK Kelas I Pontianak\bkkpontianak\resources\views/pages/backend/profil/tugas-dan-fungsi/index.blade.php ENDPATH**/ ?>