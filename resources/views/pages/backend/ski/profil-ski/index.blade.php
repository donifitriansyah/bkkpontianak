{{-- resources/views/pages/backend/profil/profil-ski/index.blade.php --}}
@extends('layouts.back')

@section('title', 'Profil SKI')
                        ...
                        <div class="modal fade" id="editModal{{ $item->id }}">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <form method="POST"
                                        action="{{ route('admin-profil-ski.update', $item->id) }}">
                                        @csrf
                                        @method('PUT')
...
<div class="modal fade" id="createModal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form method="POST" action="{{ route('admin-profil-ski.store') }}">
                @csrf
                <div class="modal-header">
...
function uploadImage(file, editor) {
    ...
    $.ajax({
        url: "{{ route('profil-ski.upload-image') }}",
        type: 'POST',
        data: data,
        contentType: false,
        processData: false,
