...
@section('title', 'Benturan Kepentingan')
                        ...
                        <div class="modal fade" id="editModal{{ $item->id }}">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <form method="POST"
                                        action="{{ route('admin-benturan-kepentingan.update', $item->id) }}">
                                        @csrf
                                        @method('PUT')
...
<div class="modal fade" id="createModal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form method="POST" action="{{ route('admin-benturan-kepentingan.store') }}">
                @csrf
...
function uploadImage(file, editor) {
    ...
    $.ajax({
        url: "{{ route('benturan-kepentingan.upload-image') }}",
        type: "POST",
        data: data,
        contentType: false,
        processData: false,
