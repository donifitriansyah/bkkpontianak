...
@section('content')
                            ...
                            <div class="modal fade" id="editModal{{ $item->id }}">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <form method="POST" action="{{ route('lapor-span.update', $item->id) }}">
                                            @csrf
                                            @method('PUT')
    ...
    <div class="modal fade" id="createModal">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form method="POST" action="{{ route('lapor-span.store') }}">
                    @csrf
                    <div class="modal-header">
    ...
    <script>
        ...
        function uploadImage(file, editor) {
            ...
            $.ajax({
                url: "{{ route('lapor-span.upload-image') }}",
                type: "POST",
                data: data,
                contentType: false,
                processData: false,
